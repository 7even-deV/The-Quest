...
class Enemy(Sprite_sheet):
    ...
    def __init__(self, screen, select, speed, player, empty_ammo_fx, bullet_fx, *args, **kwargs):
        ...
        self.vision = pygame.Rect(0, 0, self.rect.width, self.rect.height * (10 - self.random_y))
        self.idling = False
        self.direction_x = 1
        self.direction_y = 1
        self.move_counter = 0
        ...
        if self.alive and self.player.alive:
            ...
            if self.vision.colliderect(self.player.rect):
                ...
                if not self.idling:
                    ...
                    self.vision.center = (self.rect.centerx + 75 * self.direction_x, self.rect.centery + 75 * self.direction_y)
